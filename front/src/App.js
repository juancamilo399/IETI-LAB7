...
function App() {
  ...
  useEffect(() => {
    axios.get("https://taskangelapi.azurewebsites.net/api/list-tasks?code=aMS/NaSGnbQVx08aCAFTz3nxYxAhk3ZbcFWRNflYs2ZnlLy7wgIxaQ==")
      .then(response => {
        let result = response.data;
  ...
  const handleAddTask = (newTask) => {
    axios.post("https://taskangelapi.azurewebsites.net/api/add-task?code=V9YC7wcXl/172eH6WtCQaPjYWNX0IPJ/JM4C1OwZwen2KB3Q2bNlgQ==", newTask)
      .then(response => {
